...
def main():
    ...
    # Input student's personal credentials to get information on completed courses & student's faculty
    #username = sys.argv[6]
    #password = sys.argv[7]
    student_faculty = sys.argv[6]
    ...
    if scrape_student == 'y':
        ...
        real_student = False
        course_recommender.get_fake_student_completed_courses()
